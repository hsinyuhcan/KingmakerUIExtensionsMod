...
namespace UIExtensions
{
    ...
    public class DefaultLanguage : ILanguage
    {
        ...
        public Dictionary<string, string> Strings { get; set; } = new Dictionary<string, string>()
        {
            ...
            { "Menu_Sub_Inspector", "Inspector" },
            { "Menu_Opt_ChangePositionOfInspector", "Change The Position Of The Inspector" },
            { "Menu_Btn_ChangePositionOfInspectorLeft", "To The Side Of The Additional Action Bar" },
            { "Menu_Btn_ChangePositionOfInspectorTurnBased", "To The Side Of The Turned-Based Combat Tracker" },
            ...
            { "Menu_Opt_PartyHPIsShort", "Show text HP instead on HP bar" },
            ...
            { "Menu_Opt_EnemiesHPIsShort", "Show text HP instead on HP bar" },
